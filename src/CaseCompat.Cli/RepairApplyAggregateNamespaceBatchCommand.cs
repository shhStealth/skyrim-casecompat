...
public static class RepairApplyAggregateNamespaceBatchCommand
{
                ...
                beforeAuthorizationPublish)
    {
            ...
            args.Length > 5)
        {
            Console.Error.WriteLine(
                "Error: repair-apply-aggregate-namespace-batch requires a " +
                "batch directory, aggregate namespace manifest file, Skyrim " +
                "Data directory, and optional plan manifest file name."
            );
        ...
        {
            Console.Error.WriteLine(
                "Repair-apply-aggregate-namespace-batch aggregate namespace " +
                $"manifest path error: {ex.Message}"
            );
                ...
                sidecarName))
        {
            Console.Error.WriteLine(
                "Repair-apply-aggregate-namespace-batch aggregate namespace " +
                "manifest path must identify exactly one direct-child file."
            );
        ...
        catch (Exception ex)
        {
            Console.Error.WriteLine(
                "Repair-apply-aggregate-namespace-batch aggregate namespace " +
                $"manifest directory open error: {ex.Message}"
            );
            ...
            sidecarDirectoryOpen.OpenedPath is null)
        {
            Console.Error.WriteLine(
                "Repair-apply-aggregate-namespace-batch aggregate namespace " +
                "manifest directory could not be opened safely."
            );
        ...
        catch (Exception ex)
        {
            Console.Error.WriteLine(
                "Repair-apply-aggregate-namespace-batch aggregate namespace " +
                $"manifest read error: {ex.Message}"
            );
        ...
        if (!namespaceEvidence.Success)
        {
            Console.Error.WriteLine(
                "Repair-apply-aggregate-namespace-batch aggregate namespace " +
                "manifest could not be authenticated."
            );
        ...
        {
            Console.Error.WriteLine(
                "Repair-apply-aggregate-namespace-batch Skyrim Data root " +
        ...
        Console.WriteLine(
            "CaseCompat Aggregate Namespace Repair Batch Apply"
        );
        ...
        /*
         * A schema-v4 / coverage-policy-v3 batch is not allowed to enter
        ...
        if (!requiresAggregateApplyAuthority)
        {
            Console.Error.WriteLine();
            Console.Error.WriteLine(
                "Repair-apply-aggregate-namespace-batch requires an exact " +
                "schema-v4 / coverage-policy-v3 completed batch."
            );
            Console.Error.WriteLine(
                "No recorded child plan was executed by this invocation."
            );
            ...
            completionInspection.ApplyAuthorizationRead is null)
        {
                ...
                index++)
            {
                ...
                if (authenticatedManifest is null)
                {
                    Console.Error.WriteLine();
                    Console.Error.WriteLine(
                        "Repair-apply-aggregate-namespace-batch could not " +
            ...
            catch (Exception ex)
            {
                Console.Error.WriteLine();
                Console.Error.WriteLine(
                    "Repair-apply-aggregate-namespace-batch fresh aggregate " +
                    $"namespace authorization error: {ex.Message}"
                );
                Console.Error.WriteLine(
                    "No recorded child plan was executed by this invocation."
                );
            ...
            if (!freshAuthorization.AllAuthorized)
            {
                Console.Error.WriteLine();
                Console.Error.WriteLine(
                    "Repair-apply-aggregate-namespace-batch refused fresh " +
                    "aggregate namespace authorization before child mutation."
                );
                Console.Error.WriteLine(
                    $"Authorization state (internal): " +
                    $"{freshAuthorization.State}"
                );

                if (
                    !string.IsNullOrWhiteSpace(
                        freshAuthorization.Error))
                {
                    Console.Error.WriteLine(
                        $"Error: {freshAuthorization.Error}"
                    );
                }

                for (
                    int decisionIndex = 0;
                    decisionIndex < freshAuthorization.Decisions.Count;
                    decisionIndex++)
                {
                    DataRelativePathRepairBatchAggregateNamespaceApplyDecision?
                        decision =
                            freshAuthorization.Decisions[decisionIndex];
                    ...
                    Console.Error.WriteLine(
                        $"[{decision.CandidateIndex}] {decision.ChildName}: " +
                        $"{decision.State}"
                    );
            ...
            Console.WriteLine();
            Console.WriteLine(
                "Aggregate namespace apply authorization: FRESH C4A VERIFIED"
            );
                ...
                !authorizationPublicationRaceLost)
            {
                ...
                if (authorizationWrite.AuthorizationEntryChanged)
                {
                    Console.Error.WriteLine(
                        ...
                        "through repair-apply-aggregate-namespace-batch so completion inspection " +
