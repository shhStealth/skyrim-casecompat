...
public sealed class SkyrimWinningStaticInventoryTests
{
    [Fact]
    public void Inspect_UsesHighestPriorityOverrideForRecordProviderAndReference()
    {
        ...
        try
        {
            const string lowPluginName =
                "CaseCompatStaticLow.esp";

            const string highPluginName =
                "CaseCompatStaticHigh.esp";

            const string lowEditorId =
                "CaseCompatStaticLow";

            const string highEditorId =
                "CaseCompatStaticHigh";

            const string lowRequestedPath =
                "Meshes/Static/Common/lowwinner.nif";

            const string highRequestedPath =
                "Meshes/Static/Common/HighWinner.nif";
            ...
            SkyrimWinningStaticInventoryResult result =
